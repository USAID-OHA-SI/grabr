...
if (getRversion() >= "2.15.1")
  utils::globalVariables(
    c("%<>%", ".", "age_semi_fine_age", "community_lvl",
      "convert_datim_pd_to_qtr", "country", "country_iso", "country_lvl",
      "country_uid", "countryname", "dimension", "disaggregation_type",
      "displayName", "display_name", "e_tag", "etag", "facility_lvl","filepath",
      "fiscal_year", "id", "iso3", "iso4", "item", "key", "label",
      "last_modified", "level", "msd_release", "name3", "name4", "ndir",
